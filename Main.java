...
class Main {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            System.out.println("1. Add a new room number");
            System.out.println("2. Search the path to your room");
            System.out.println("3. Exit the building");
            int ch = sc.nextInt();
            
            switch(ch){
                case 1:
                    System.out.println("Enter the room number to add: ");
                    int x = sc.nextInt();
                    root = sol.insert(root,x);
                    System.out.println("Room number added.");
                    System.out.println();
                ...
                case 2:
                    ...
                    if(sol.search(root,y,path)){
                        System.out.println("Path to the room : "+path);
                    }else{
                        System.out.println("Oh no! Seems like the room number you are looking for is not in the building.");
                    }
                    System.out.println();
                    break;
...
class Solution {
    ...
    boolean search(BSTNode root,int x, List<String> path){
        if(root == null){
            return false;
        }
        if(x==root.data){
